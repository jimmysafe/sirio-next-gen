              ...
              <section className="p-4 pt-0">
                ...
                <div className="flex items-center gap-2">
                  <Avatar className="size-12">
                    <AvatarImage
                      src={((course.teacher as Teacher).photo as Media).url || "/assets/placeholder.jpg"}
                      alt={(course.teacher as Teacher).cognome}
                    />
                    <AvatarFallback>JD</AvatarFallback>
                  </Avatar>
                  <div className="flex flex-col gap-px">
                    <span className="text-xs font-medium">
                      {(course.teacher as Teacher).nome}{" "}{(course.teacher as Teacher).cognome}
                    </span>
